...
"Wrecker",	"1",  ]
        ...
        "Attacking unit with Ancient Power Core stuns them, but then gives the attacker the Ancient Power Core",
        "Using a special ability increases the cooldown of all other special abilities by 1",
        "Reinforcements are inflicted with shield distruption for 2 turns when called in",
        "Whenever an Empire enemy uses a special, they increase the damage they deal by 10% until the end of the encounter. Then all empire allies are called to assist"
        ],
        notes:[
